...
$("#conf_1").click(function() {
  swal({
    title: "Alexandre Noir",
    text: conf_1,
  });
});
...
$("#conf_2").click(function() {
  swal({
    title: "Marc Klein, Arturo Fuentes",
    text: conf_2,
  });
});
...
$("#conf_5").click(function() {
  swal({
    title: "Gilberto L. Rodriguez",
    text: conf_5,
  });
});

var conf_6 = `Perkins and Will
Tema: Temas relacionado con experiencia y procesos de trabajo en Perkins & Will / Resiliencia & Sustentabilidad / Trends en Educación
Fecha y hora:  Jueves 14 a las 9:00 a.m. 
Lugar: Centro de Congresos
`
$("#conf_6").click(function() {
  swal({
    title: "Antonio Perez",
    text: conf_6,
  });
...
$("#conf_10").click(function() {
  swal({
    title: "Omar Vazquez Sanchez",
    text: conf_10,
  });
});

var conf_11 = `Macia Estudios
Tema: Territorios para el juego
Fecha y hora: Viernes 15 a las 10:00 a.m.
Lugar: Auditorio Bibliotec
`
$("#conf_11").click(function() {
  swal({
    title: "Mariana Rios Robles",
    text: conf_11,
  });
});
